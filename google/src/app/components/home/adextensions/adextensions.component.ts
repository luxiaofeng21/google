...
@Component({
  selector: 'app-adextensions',
  templateUrl: './adextensions.component.html',
  styleUrls: ['./adextensions.component.scss']
})
export class AdextensionsComponent implements OnInit {
  ...
  public listOfData = [
    {
      ...
      state:true,
      info:{
          name1:"sadsa d | asdasdsad | asdasd",
          name2:"‪www.baidu.com/aa/aaa‬",
          name3:"asdas。dasdsad。"
      },
      name:"广告组1",
      name1: '测试推广',
  ...
  //筛选
  addList=["自适应搜索广告","来电广告","动态搜索广告","自适应型展示广告"]
  filters=[]
  info={
    value:"",
    title:"",
